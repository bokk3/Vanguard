...
| **[`vanguard_title_logo.png`](vanguard_title_logo.png)** | `800x220` Transparent PNG | Game Title Splash, Menu Header | Stylized aerospace typography logo with tactical cyan chevron backdrop and titanium borders. |
